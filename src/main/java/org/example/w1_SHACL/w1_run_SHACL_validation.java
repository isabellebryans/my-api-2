...
public class w1_run_SHACL_validation {
    public static int handleValidation(Move move) throws FileNotFoundException, IOException {
        ...
        Graph dataGraph = loadData.initAndLoadModelFromResource("chessBoardstructure.ttl", Lang.TURTLE)
                ...
                .union(loadData.initAndLoadModelFromResource("CRchessMove.ttl", Lang.TURTLE))
                .getGraph();
